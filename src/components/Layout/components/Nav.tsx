...
const Nav = () => {
  return (
    <nav className='flex h-full w-56'>
      <div className='relative '>
        <div className='flex flex-col sm:flex-row sm:justify-around'>
          <div className='h-screen w-56'>
            <ul className='relative'>
              <li className='relative'>
                <p className='my-3 flex cursor-pointer items-center rounded-lg p-2 text-gray-600 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-800  dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white '>
                  <svg
                    fill='currentColor'
                  ...
                  <span className='flex-grow text-right'>v</span>
                </p>
            ...
            <a
              className='my-3 flex items-center rounded-lg bg-gray-100 p-2 text-gray-800 transition-colors duration-200 hover:bg-gray-100  hover:text-gray-800 dark:bg-gray-600 dark:text-gray-100 dark:hover:bg-gray-600 dark:hover:text-white'
              href='#'
            >
              <svg
                width='20'
